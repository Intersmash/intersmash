...
import org.jboss.intersmash.provision.operator.hyperfoil.client.v05.model.Agent;
import org.jboss.intersmash.provision.operator.hyperfoil.client.v05.model.Histogram;
import org.jboss.intersmash.provision.operator.hyperfoil.client.v05.model.Phase;
import org.jboss.intersmash.provision.operator.hyperfoil.client.v05.model.RequestStatisticsResponse;
import org.jboss.intersmash.provision.operator.hyperfoil.client.v05.model.RequestStats;
		...
		public OffsetDateTime read(JsonReader in) throws IOException {
			switch (in.peek()) {
				...
				default:
					...
					return OffsetDateTime.parse(date.replaceAll("/", "-").replaceAll(" ", "T"), formatter);
			}
		}
	}
