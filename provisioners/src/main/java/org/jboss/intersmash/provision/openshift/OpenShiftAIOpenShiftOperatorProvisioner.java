...
/**
 * A {@link org.jboss.intersmash.provision.Provisioner} that extends {@link OpenShiftAIOperatorProvisioner} and
 * is able to deploy the OpenShift AI Operator on OpenShift specifically.
 */
public class OpenShiftAIOpenShiftOperatorProvisioner
		// leverage OpenShift AI common Operator based provisioner behavior
		extends OpenShiftAIOperatorProvisioner<NamespacedOpenShiftClient>
