...
/**
 * End user Application interface which presents an OpenShift AI operator application.
 * Only relevant model APIs are currently exposed, more would be added on demand
 *
 * The application will be deployed by:
 * <ul>
 *     <li>{@link org.jboss.intersmash.provision.operator.OpenShiftAIOperatorProvisioner}</li>
 * </ul>
 */
public interface OpenShiftAIOperatorApplication extends OperatorApplication {
