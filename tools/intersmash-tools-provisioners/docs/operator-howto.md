...
* Copy the relevant operator CRDs in tools/intersmash-tools-provisioners/src/main/resources/crds
* Build Intersmash
* Check tools/intersmash-tools-provisioners/target/generated-sources and look for the expected JOSDK sources

### Create Application & Provisioner
* create org.jboss.intersmash.tools.application.openshift.${PRODUCT}OperatorApplication, extending OperatorApplication
* create org.jboss.intersmash.tools.provision.openshift.${PRODUCT}OperatorProvisioner, extending OperatorProvisioner<${PRODUCT}OperatorApplication>
