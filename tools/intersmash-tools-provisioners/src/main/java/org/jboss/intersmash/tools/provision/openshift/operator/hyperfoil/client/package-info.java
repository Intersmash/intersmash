 ...
 *              --api-package org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05 \
 *              --invoker-package org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05.invoker \
 *              --model-package org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05.model \
 *              --package-name org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05
 *     </code>
 *     After code generation, you need to manually fix the following:
 * </p>
 * <ul>
 *     <li>HyperfoilApi: delete `import org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05.model.AddBenchmarkRequest;`</li>
 ...
 *     <li>fix method
 *     {@link org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05.model.Run#validateJsonObject(com.google.gson.JsonObject)}
 *     </li>
 *     <li>fix method
 *     {@link org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05.model.Agent#validateJsonObject(com.google.gson.JsonObject)}
 *     </li>
 *     <li>fix method
 *     {@link org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05.model.Phase#validateJsonObject(com.google.gson.JsonObject)}
 *     </li>
 *     <li>fix method
 *     {@link org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05.model.Histogram#validateJsonObject(com.google.gson.JsonObject)}
 *     </li>
 *     <li>fix method
 *     {@link org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.v05.invoker.JSON.OffsetDateTimeTypeAdapter#read(com.google.gson.stream.JsonReader)}
 *     </li>
 *     <li>fix
 *     {@link org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client.runschema.v06}: use
 ...
 * </ul>
 */
package org.jboss.intersmash.tools.provision.openshift.operator.hyperfoil.client;