//TODO: remove once https://github.com/xtf-cz/xtf/pull/546 and https://github.com/xtf-cz/xtf/pull/547 are merged and xtf upgraded
...
public class ContainerBuilder implements EnvironmentConfiguration, ResourceLimitBuilder {
	...
	public ContainerBuilder configFromConfigMap(String configMapName, Function<String, String> nameMapping,
		...
		configMapKeys.forEach(x -> referredEnvVars.put(nameMapping.apply(x), new ConfigMapEntry(x, configMapName)));
		return this;
	}
