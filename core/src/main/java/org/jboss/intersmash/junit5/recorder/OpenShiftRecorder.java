...
public @interface OpenShiftRecorder {
	...
	/**
	 * Resource names for filtering out events, pods, etc.
	 * Will be turned into regex {@code __value__.*}
	 *
	 * If no value is given, resources are filtered automatically by recording what resources
	 * are seen before the test and so on.
	 */
